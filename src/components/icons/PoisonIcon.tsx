interface PoisonIcon {
  height?: string;
  width?: string;
  small?: string;
}

export const PoisonIcon: React.FC<PoisonIcon> = ({
  height = '50', 
  width = '50', 
  small='false'
}) => {
