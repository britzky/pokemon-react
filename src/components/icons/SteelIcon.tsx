interface SteelIconProps {
  height?: string;
  width?: string;
  small?: string;
}

export const SteelIcon: React.FC<SteelIconProps> = ({
  height = '50', 
  width = '50', 
  small='false'
}) => {
